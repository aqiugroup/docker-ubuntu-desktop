...
echo "
USAGE:
docker run -itd -p 6901:6901 -p 5901:5901 imgyh/<image>:<tag> <option>
...
-s, --skip      skip the vnc startup and just execute the assigned command.
                example: docker run imgyh/docker-ubuntu-desktop --skip bash
-d, --debug     enables more detailed startup output
                e.g. 'docker run imgyh/docker-ubuntu-desktop --debug bash'
-h, --help      print out this help

Fore more information see: https://github.com/imgyh/docker-ubuntu-desktop
"
}
if [[ $1 =~ -h|--help ]]; then
    help
